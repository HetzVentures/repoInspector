        ...
        <Transition name="bounce">
          ...
          <template v-if="!token">
              ...
              <article>
                ...
                <footer>
                  <a role="button" target="_blank" href="https://github.com/HetzVentures/repoInspector" class="outline">Get started</a>
                </footer>
              </article>
          ...
          <template v-else-if="!currentUser.email">
            <article>
                ...
                Please login with your Gmail account below. You’ll get the results of your inspection via this email.
                Your email is <b>only</b> used to deliver your inspection results.
                The inspection is done on your computer, and we aggregate the data for you to send it directly to you. 
                <footer>
                  <button v-bind:aria-busy="setupDelay" v-bind:disabled="!currentUser?.uuid || setupDelay"  v-on:click="openLogin()">Log in to Gmail</button>
